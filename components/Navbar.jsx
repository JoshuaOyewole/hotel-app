...
<nav className="bg-gray-800">
  <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
    ...
    <div className="absolute inset-y-0 right-0 flex items-center sm:hidden">
      ...
      <div className="absolute inset-y-0 left-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
        <p className="bg-gray-800 text-white p-1 rounded-full text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
            Hydak Hotels
        </p>
    ...
    <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-end">
        <div className="hidden sm:block sm:ml-6">
          <div className="flex space-x-4">
            ...
            <Link href="#">
              <a className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Rooms</a>
            </Link>

            <Link href="#">
              <a  className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Galaries</a>
            </Link>
            <Link href="#">
  ...
  <div className={isActive ? "hidden" : "sm:hidden"} id="mobile-menu" ref={toggleBtn} >
    <div className="px-2 pt-2 pb-3 space-y-1">
      ...
      <Link href='#'>
        <a className="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Rooms</a>
      </ Link>

      <Link href='#'>
        <a className="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Galaries</a>
      </Link>
